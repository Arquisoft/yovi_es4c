...
The deployment url is: [https://arquisoft.github.io/yovi_es4c/](https://arquisoft.github.io/yovi_es4c/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es4c/](https://arquisoft.github.io/yovi_es4c/), we need to execute `npm run deploy`.
