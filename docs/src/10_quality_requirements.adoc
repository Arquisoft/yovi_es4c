...
** Rendimiento
*** Tiempo de respuesta bajo durante la partida
** Mantenibilidad
*** Código modular y fácil de modificar o ampliar
** Fiabilidad
*** Manejo adecuado de errores y mantenimiento de la coherencia del estado del juego ante fallos o situaciones inesperadas
@endmindmap
----
